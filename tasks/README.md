...
| [17-subfolder-import-and-tree-view.md](./17-subfolder-import-and-tree-view.md) | 子文件夹导入修复 + 文件表改树形（数据库驱动 subfolder，与物理解耦） | M+M+S | P0/P1/P1 | 待做 |
...
| [28-export-structure-option.md](./28-export-structure-option.md) | 导出项目时支持按 UI 目录树建文件结构（保留 subfolder / 拍平 二选一） | XS | P2 | 待做（依赖 #17） |
