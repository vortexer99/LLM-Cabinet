...
| [03-search-calibre-like.md](./03-search-calibre-like.md) | 类 Calibre 的搜索（关键词 + 字段 + 布尔 + 搜索历史 + 收藏表达式）；已拆 Phase A (XS~S) + Phase B (M) + Phase C (XS) | M | P0 | 🚧 Phase A 完成（Phase B/C 待做） |
...
| [25-project-list-batch-and-dnd.md](./25-project-list-batch-and-dnd.md) | 项目列表多选 + 批量操作适配 + 标签拖放赋值 | S+M | P1 | ✅ 2026-07-06 |
...
| [29-file-storage-location-management.md](./29-file-storage-location-management.md) | 文件存储位置管理（T1 链接转仓储 / T2 移动 / T3a 重关联 / T3b 替换链接 / T3c 文件夹粒度） | S+S+S+S | P2 | ✅ 2026-07-06（v0.6 未发布） |
