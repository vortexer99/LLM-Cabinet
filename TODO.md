...
[#10 · ⚪] 批量按文件夹导入，每个文件夹作为一个项目。作为导入功能的子分支（检测到导入多个文件夹且仅有文件夹时触发）
[#10 · ⚪] 导入文件夹时创建项目时检测是否已经有导出的项目配置文件
-
...
| [10](./tasks/10-folder-batch-import.md) | 文件夹批量导入 + project.json 识别 | S+S | P1 | 待做 |
