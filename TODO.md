...
[#04 · ⚪] 项目部分文件为软件运行所需的配置文件，需要单独分类并折叠（澄清完毕：二态视图按 #30 origin 筛选）
...
[#30 · ⚪] 文件来源标记 files.origin（user/generated）：区分用户原始文件与软件衍生物（封面快照等），schema v7→v8；服务于 #28 导出导入、相邻 #04 系统文件折叠
