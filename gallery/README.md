...
Github showcase screenshots, `NN-keyword_中文名.png`.

| # | File | Content |
|---|------|---------|
| 01 | `01-main-window_主界面.png` | Full main window — tag tree, project list, preview & file table |
| 02 | `02-project-edit_项目编辑.png` | Project edit dialog with inline LLM suggestions |
