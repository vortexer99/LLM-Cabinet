...
- **Search and tags**: use the top search box to filter project titles/descriptions, and combine it with sidebar tag filters or tag-folder filters. Tags are a first-class multi-value field.
